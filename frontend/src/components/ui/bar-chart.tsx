...
function ChartTooltipContent({
    ...
    formatter?: (value: number, name: string, item: TooltipPayloadItem, index: number, payload: unknown) => React.ReactNode
    color?: string
    nameKey?: string
    labelKey?: string
}) {
    ...
    return (
        <div
            className={cn(
                "border-border/50 bg-[#18181B] grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-white/10 px-2.5 py-1.5 text-xs shadow-xl",
                className
            )}
        >
...
// Custom Gradient Bar for beautiful charts
