                        ...
                        <div className="space-y-4">
                            ...
                            {youtubeConnected ? (
                                <div className="flex items-center gap-3 p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl">
                                    <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-[#FF0000] flex items-center justify-center shadow-md shadow-red-500/10">
                            ...
                            <div className="p-4 bg-[#0A0A0A] rounded-xl border border-white/5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-14 h-14 bg-[#FF0000] rounded-xl flex items-center justify-center shadow-lg shadow-red-500/10 flex-shrink-0">
                                            <img src="/yt_icon_white_digital.png" alt="YouTube" className="w-8 h-8 object-contain" />
                                        </div>
                                        <div>
